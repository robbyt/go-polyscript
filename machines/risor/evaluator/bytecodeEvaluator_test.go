...
// TestBytecodeEvaluator_Success tests evaluating valid Risor scripts
func TestBytecodeEvaluator_Success(t *testing.T) {
	t.Parallel()
...
// TestBytecodeEvaluator_Metadata tests string representation and metadata methods
func TestBytecodeEvaluator_Metadata(t *testing.T) {
	t.Parallel()
...
// TestBytecodeEvaluator_Errors tests error conditions for the Eval method
func TestBytecodeEvaluator_Errors(t *testing.T) {
	t.Parallel()
...
// TestBytecodeEvaluator_LoadInputData tests the loadInputData method
func TestBytecodeEvaluator_LoadInputData(t *testing.T) {
	t.Parallel()
...
// TestBytecodeEvaluator_New tests creating a new BytecodeEvaluator with various options
func TestBytecodeEvaluator_New(t *testing.T) {
	t.Parallel()
